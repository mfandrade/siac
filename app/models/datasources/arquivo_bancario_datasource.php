<?php
/**
 * ArquivoBancario class
 *
 * Based on CSV datasource at http://bakery.cakephp.org/articles/view/csv-datasource-for-reading-your-csv-files
 *
 * @author Marcelo F Andrade <mfandrade@gmail.com>
 * @copyright Copyright 2008-2009, Marcelo F Andrade
 * @license http://www.opensource.org/licenses/mit-license.php The MIT License
 * @created September 09, 2009
 * @version 1.0
 **/
class ArquivoBancarioSource extends DataSource {
 ...
 * @var unknown_type
 */
	var $description	= "ArquivoBancario Data Source";
	var $maxCol			= 0;
 ...
 */
	var $__baseConfig = array(
		...
		, 'extension'	=> 'txt'	// file extension of CSV Files
